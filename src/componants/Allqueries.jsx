        ...
        <div >
            ...
            <div className="max-w-sm my-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="p-5">
                    ...
                    <p className="mb-3 font-normal text-gray-700 flex items-center gap-10 dark:text-gray-400"><span><img className='w-16 rounded-xl h-16' src={image} alt="" /></span><span>{user_name}</span></p>
